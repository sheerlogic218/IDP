...
const int TESTING = 8;
const int DROP_OFF_ANT = 9;                 // ANT MEANS After Next Turn
const int EXPECT_BLOCK_ANT = 10;            // These are a couple of methods that setup the system to perform things on paths
const int EXPECT_BLOCK_180_ANT = 11;        // These are a couple of methods that setup the system to perform things on paths
const int ROBOT_GO_WEE_WOO_ANT_FIRST = 12;  // These things are meant to be done during navigation but called after a junction
const int ROBOT_GO_WEE_WOO_ANT_SECOND = 13; // These things are meant to be done during navigation but called after a junction
const int COMPLETED_ANT = 14;
const int COMPLETED = 15;
...
int path[] = {
    ...
    LEFT, RIGHT, EXPECT_BLOCK_180_ANT, RIGHT,
...
void drop_off()
{
  ...
  while (millis() < drop_start + 1500UL)
  {
